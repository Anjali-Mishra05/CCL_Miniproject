    ...
    try {
        ...
        const response = await fetch(
            `${CONFIG.API_BASE_URL}/search?type=${type}&species=${species}&location=${location}`
        );
    ...
    document.getElementById('report-form')?.addEventListener('submit', async (e) => {
        ...
        const data = {
            ...
            details: document.getElementById('pet-description').value,
            location: document.getElementById('pet-location').value,
            dateLost: document.getElementById('pet-date').value,
        ...
        try {
            ...
            const res = await fetch(`${CONFIG.API_BASE_URL}/pets`, {
                method: "POST",
                headers: {
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        if (!user) {
            showPage('auth-page');   // force login
        } else {
            showPage('home-page');
        }
